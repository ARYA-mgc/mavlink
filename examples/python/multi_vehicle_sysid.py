...
Multiple vehicles on one link get demuxed into per-(sysid, compid)
state, tracked for liveness, and one is targeted with a command.
"""
...
class MavlinkFleetRouter:
    """Demultiplexes MAVLink traffic and tracks per-(sysid, compid) state."""
